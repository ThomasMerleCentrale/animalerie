        ...
        if form.is_valid():
            if form.data['lieu'] == 'mangeoire':
                if mangeoire.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': "La mangeoire est full"})
                ...
                if nid.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Le nid est full"})            
                ...
                if litière.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"La litière est full"})              
